...
def get_sched(units,StartDate,EndDate):
    ...
    for i in unitid:
        ...
        payload = "sort=&group=&filter=&dateStart=" + str(Inicio) + "&dateEnd=" + str(
            Fim) + "&Client=&Item=&DetailLevel%5B0%5D=Date&DetailLevel%5B1%5D=Hour&DetailLevel%5B2%5D=Establishment&DetailLevel%5B3%5D=Locality&DetailLevel%5B4%5D=Status&DetailLevel%5B5%5D=Client&DetailLevel%5B6%5D=CreateUser&DetailLevel%5B7%5D=CreateUserProfile&DetailLevel%5B8%5D=Item&DetailLevel%5B9%5D=MediaType&DetailLevel%5B10%5D=SchedulerDate&DetailLevel%5B11%5D=Origin"
        headers = {
...
LimitDate = datetime.datetime(2021,1, 1, 00, 00, 00)
...
while True:
    ...
    hash(df, df, 'ClientPhone', 'CreateUser','Item', 'SchedulerDate')  # Generating hash
